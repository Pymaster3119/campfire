...
public partial class ZombieScript : Node2D
{
	...
	private void ConnectNeighbors(Vector2I cell, int id)
	{
		...
		foreach (var dir in directions)
		{
			...
			bool allow = (dir == Vector2I.Left || dir == Vector2I.Right) || ((dir == Vector2I.Up || dir == Vector2I.Down) && IsLadderTile(cell) && IsLadderTile(neighbor));
	...
	public override void _Process(double delta)
	{
		...
		if (_currentPath != null && _pathIndex < _currentPath.Length)
		{
			...
			else
			{
				...
				if (GlobalPosition.DistanceTo(targetPoint) < 0.1f)
					_pathIndex++;
			}
		}
